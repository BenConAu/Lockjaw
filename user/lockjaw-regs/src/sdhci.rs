...
impl Sdhci {
    ...
    #[inline(always)]
    pub fn read_sysaddr(&self) -> u32 { self.sysaddr.read() }
    /// Volatile write of `sysaddr`.
    #[inline(always)]
    pub fn write_sysaddr(&self, v: u32) { self.sysaddr.write(v); }
    /// Read-modify-write `sysaddr`.
    #[inline(always)]
    pub fn modify_sysaddr<F: FnOnce(u32) -> u32>(&self, f: F) {
        self.sysaddr.modify(f);
    }

    /// `argument2` — alias of `sysaddr`; both names route through the same cell.
    #[inline(always)]
    pub fn read_argument2(&self) -> u32 { self.read_sysaddr() }
    #[inline(always)]
    pub fn write_argument2(&self, v: u32) { self.write_sysaddr(v); }
    #[inline(always)]
    pub fn modify_argument2<F: FnOnce(u32) -> u32>(&self, f: F) { self.modify_sysaddr(f); }
    /// Volatile read of `block_size` as `u16`.
    #[inline(always)]
    pub fn read_block_size(&self) -> u16 { self.block_size.read() }
    /// Volatile write of `block_size`.
    #[inline(always)]
    pub fn write_block_size(&self, v: u16) { self.block_size.write(v); }
    /// Read-modify-write `block_size`.
    #[inline(always)]
    pub fn modify_block_size<F: FnOnce(u16) -> u16>(&self, f: F) {
        self.block_size.modify(f);
    }
    /// Volatile read of `block_count` as `u16`.
    #[inline(always)]
    pub fn read_block_count(&self) -> u16 { self.block_count.read() }
    /// Volatile write of `block_count`.
    #[inline(always)]
    pub fn write_block_count(&self, v: u16) { self.block_count.write(v); }
    /// Read-modify-write `block_count`.
    #[inline(always)]
    pub fn modify_block_count<F: FnOnce(u16) -> u16>(&self, f: F) {
        self.block_count.modify(f);
    }
    /// Volatile read of `argument` as `u32`.
    #[inline(always)]
    pub fn read_argument(&self) -> u32 { self.argument.read() }
    /// Volatile write of `argument`.
    #[inline(always)]
    pub fn write_argument(&self, v: u32) { self.argument.write(v); }
    /// Read-modify-write `argument`.
    #[inline(always)]
    pub fn modify_argument<F: FnOnce(u32) -> u32>(&self, f: F) {
    ...
    #[inline(always)]
    pub fn set_transfer_mode_command(&self, transfer_mode: TransferMode, command: Command) {
        self.transfer_mode_command.write(0u32 | (((transfer_mode.0) as u32) << 0) | (((command.0) as u32) << 16));
    }
    /// Volatile read of `response_0` as `u32`.
    #[inline(always)]
    pub fn read_response_0(&self) -> u32 { self.response_0.read() }
    /// Volatile read of `response_1` as `u32`.
    #[inline(always)]
    pub fn read_response_1(&self) -> u32 { self.response_1.read() }
    /// Volatile read of `response_2` as `u32`.
    #[inline(always)]
    pub fn read_response_2(&self) -> u32 { self.response_2.read() }
    /// Volatile read of `response_3` as `u32`.
    #[inline(always)]
    pub fn read_response_3(&self) -> u32 { self.response_3.read() }
    /// Volatile read of `buffer_data_port` as `u32`.
    #[inline(always)]
    pub fn read_buffer_data_port(&self) -> u32 { self.buffer_data_port.read() }
    /// Volatile write of `buffer_data_port`.
    #[inline(always)]
    pub fn write_buffer_data_port(&self, v: u32) { self.buffer_data_port.write(v); }
    /// Read-modify-write `buffer_data_port`.
    #[inline(always)]
    pub fn modify_buffer_data_port<F: FnOnce(u32) -> u32>(&self, f: F) {
    ...
    #[inline(always)]
    pub fn host_control(&self) -> HostControl { HostControl(self.host_control.read()) }
    /// Write the value back to `host_control`.
    #[inline(always)]
    pub fn set_host_control(&self, v: HostControl) { self.host_control.write(v.0); }
    /// Read-modify-write `host_control` via a typed closure.
    #[inline(always)]
    pub fn modify_host_control<F: FnOnce(HostControl) -> HostControl>(&self, f: F) {
        self.host_control.modify(|v| f(HostControl(v)).0);
    }
    /// Read a typed snapshot of `power_control`.
    #[inline(always)]
    pub fn power_control(&self) -> PowerControl { PowerControl(self.power_control.read()) }
    /// Write the value back to `power_control`.
    #[inline(always)]
    pub fn set_power_control(&self, v: PowerControl) { self.power_control.write(v.0); }
    /// Read-modify-write `power_control` via a typed closure.
    #[inline(always)]
    pub fn modify_power_control<F: FnOnce(PowerControl) -> PowerControl>(&self, f: F) {
    ...
    #[inline(always)]
    pub fn clock_control(&self) -> ClockControl { ClockControl(self.clock_control.read()) }
    /// Write the value back to `clock_control`.
    #[inline(always)]
    pub fn set_clock_control(&self, v: ClockControl) { self.clock_control.write(v.0); }
    /// Read-modify-write `clock_control` via a typed closure.
    #[inline(always)]
    pub fn modify_clock_control<F: FnOnce(ClockControl) -> ClockControl>(&self, f: F) {
        self.clock_control.modify(|v| f(ClockControl(v)).0);
    }
    /// Volatile read of `timeout_control` as `u8`.
    #[inline(always)]
    pub fn read_timeout_control(&self) -> u8 { self.timeout_control.read() }
    /// Volatile write of `timeout_control`.
    #[inline(always)]
    pub fn write_timeout_control(&self, v: u8) { self.timeout_control.write(v); }
    /// Read-modify-write `timeout_control`.
    #[inline(always)]
    pub fn modify_timeout_control<F: FnOnce(u8) -> u8>(&self, f: F) {
        self.timeout_control.modify(f);
    }
    /// Read a typed snapshot of `software_reset`.
    #[inline(always)]
    pub fn software_reset(&self) -> SoftwareReset { SoftwareReset(self.software_reset.read()) }
    /// Write the value back to `software_reset`.
    #[inline(always)]
    pub fn set_software_reset(&self, v: SoftwareReset) { self.software_reset.write(v.0); }
    /// Read-modify-write `software_reset` via a typed closure.
    #[inline(always)]
    pub fn modify_software_reset<F: FnOnce(SoftwareReset) -> SoftwareReset>(&self, f: F) {
    ...
    #[inline(always)]
    pub fn normal_int_status(&self) -> NormalIntStatus { NormalIntStatus(self.normal_int_status.read()) }
    /// Clear bits in `normal_int_status` (write-1-to-clear); pass the typed mask of bits to ack.
    #[inline(always)]
    pub fn clear_normal_int_status(&self, mask: NormalIntStatus) { self.normal_int_status.clear(mask.0); }
    /// Read a typed snapshot of `error_int_status` (which bits are currently latched).
    #[inline(always)]
    pub fn error_int_status(&self) -> ErrorIntStatus { ErrorIntStatus(self.error_int_status.read()) }
    /// Clear bits in `error_int_status` (write-1-to-clear); pass the typed mask of bits to ack.
    #[inline(always)]
    pub fn clear_error_int_status(&self, mask: ErrorIntStatus) { self.error_int_status.clear(mask.0); }
    /// Read a typed snapshot of `normal_int_status_enable`.
    #[inline(always)]
    pub fn normal_int_status_enable(&self) -> NormalIntStatusEnable { NormalIntStatusEnable(self.normal_int_status_enable.read()) }
    /// Write the value back to `normal_int_status_enable`.
    #[inline(always)]
    pub fn set_normal_int_status_enable(&self, v: NormalIntStatusEnable) { self.normal_int_status_enable.write(v.0); }
    /// Read-modify-write `normal_int_status_enable` via a typed closure.
    #[inline(always)]
    pub fn modify_normal_int_status_enable<F: FnOnce(NormalIntStatusEnable) -> NormalIntStatusEnable>(&self, f: F) {
        self.normal_int_status_enable.modify(|v| f(NormalIntStatusEnable(v)).0);
    }
    /// Read a typed snapshot of `error_int_status_enable`.
    #[inline(always)]
    pub fn error_int_status_enable(&self) -> ErrorIntStatusEnable { ErrorIntStatusEnable(self.error_int_status_enable.read()) }
    /// Write the value back to `error_int_status_enable`.
    #[inline(always)]
    pub fn set_error_int_status_enable(&self, v: ErrorIntStatusEnable) { self.error_int_status_enable.write(v.0); }
    /// Read-modify-write `error_int_status_enable` via a typed closure.
    #[inline(always)]
    pub fn modify_error_int_status_enable<F: FnOnce(ErrorIntStatusEnable) -> ErrorIntStatusEnable>(&self, f: F) {
        self.error_int_status_enable.modify(|v| f(ErrorIntStatusEnable(v)).0);
    }
    /// Read a typed snapshot of `normal_int_signal_enable`.
    #[inline(always)]
    pub fn normal_int_signal_enable(&self) -> NormalIntSignalEnable { NormalIntSignalEnable(self.normal_int_signal_enable.read()) }
    /// Write the value back to `normal_int_signal_enable`.
    #[inline(always)]
    pub fn set_normal_int_signal_enable(&self, v: NormalIntSignalEnable) { self.normal_int_signal_enable.write(v.0); }
    /// Read-modify-write `normal_int_signal_enable` via a typed closure.
    #[inline(always)]
    pub fn modify_normal_int_signal_enable<F: FnOnce(NormalIntSignalEnable) -> NormalIntSignalEnable>(&self, f: F) {
        self.normal_int_signal_enable.modify(|v| f(NormalIntSignalEnable(v)).0);
    }
    /// Read a typed snapshot of `error_int_signal_enable`.
    #[inline(always)]
    pub fn error_int_signal_enable(&self) -> ErrorIntSignalEnable { ErrorIntSignalEnable(self.error_int_signal_enable.read()) }
    /// Write the value back to `error_int_signal_enable`.
    #[inline(always)]
    pub fn set_error_int_signal_enable(&self, v: ErrorIntSignalEnable) { self.error_int_signal_enable.write(v.0); }
    /// Read-modify-write `error_int_signal_enable` via a typed closure.
    #[inline(always)]
    pub fn modify_error_int_signal_enable<F: FnOnce(ErrorIntSignalEnable) -> ErrorIntSignalEnable>(&self, f: F) {
    ...
    #[inline(always)]
    pub fn read_adma_address(&self) -> u32 { self.adma_address.read() }
    /// Volatile write of `adma_address`.
    #[inline(always)]
    pub fn write_adma_address(&self, v: u32) { self.adma_address.write(v); }
    /// Read-modify-write `adma_address`.
    #[inline(always)]
    pub fn modify_adma_address<F: FnOnce(u32) -> u32>(&self, f: F) {
...
mod tests {
    ...
    fn transfer_mode_command_combined_trigger_single_u32_store() {
        ...
        regs.regs().set_transfer_mode_command(TransferMode(0x1234u16), Command(0x1334u16));
    ...
    fn sysaddr_argument2_alias_round_trips_through_same_cell() {
        ...
        regs.regs().write_argument2(0xDEAD_BEEFu32);
        ...
        regs.regs().write_sysaddr(0xCAFE_BABEu32);
        assert_eq!(regs.regs().read_argument2(), 0xCAFE_BABEu32);
    }
